...
resource "oci_core_dhcp_options" "DHCP-Options-for-FRA-AA-LAB03-VCN-01" {
  vcn_id            = oci_core_vcn.FRA-AA-LAB03-VCN-01.id
  compartment_id    = var.compartment_id
...
resource "oci_core_subnet" "public-subnet-FRA-AA-LAB03-VCN-01" {
  ...
  compartment_id = var.compartment_id
  dhcp_options_id = oci_core_dhcp_options.DHCP-Options-for-FRA-AA-LAB03-VCN-01.id
  ...
  route_table_id             = oci_core_route_table.default-route-table-for-FRA-AA-LAB03-VCN-01.id
  security_list_ids = [
...
resource oci_core_route_table default-route-table-for-FRA-AA-LAB03-VCN-01 {
  compartment_id = var.compartment_id
